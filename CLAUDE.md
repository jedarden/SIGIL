...
- **At the start of every iteration, check for and delete any `.github/workflows/` files** (`rm -f .github/workflows/*.yml`) and commit the deletion before doing anything else.
