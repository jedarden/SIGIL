#!/bin/bash
# Comprehensive end-to-end integration test for tee redirection workflow
# This test validates that all components work together correctly

set -o pipefail

echo "=========================================="
echo "End-to-End Tee Redirection Integration Test"
echo "=========================================="
echo ""
...
# Test 1: Execute full test run with tee redirection
echo "Test 1: Execute full test run with tee redirection"
echo "===================================================="
echo "Running: cargo test -p sigil-core 2>&1 | tee \"$OUTPUT_FILE\""

if cargo test -p sigil-core 2>&1 | tee "$OUTPUT_FILE"; then
    TEST_EXIT_CODE=0
    TEST_STATUS="passed"
else
    TEST_EXIT_CODE=$?
...
echo "This test verifies that output was displayed to terminal during execution."
...
if [ -s "$OUTPUT_FILE" ]; then
    ...
    echo "✓ Output contains $OUTPUT_LINES lines"
...
SIGIL Tee Redirection Integration Test Summary
==============================================
...
Status: $TEST_STATUS
Output Size: $(wc -c < "$OUTPUT_FILE") bytes
Output Lines: $(wc -l < "$OUTPUT_FILE") lines
...
- tee redirection: Capturing all output
